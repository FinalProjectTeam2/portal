...
public class BoardVO {
	...
	public String toString() {
		return "BoardVO [bdCode=" + bdCode + ", officialNo=" + officialNo + ", bdName=" + bdName + ", regDate="
				+ regDate + ", editDate=" + editDate + ", bdOrder=" + bdOrder + ", usage=" + usage + ", isReply="
				+ isReply + ", isComment=" + isComment + ", isPrivate=" + isPrivate + ", isUpload=" + isUpload
				+ ", maxUpfile=" + maxUpfile + ", maxFilesize=" + maxFilesize + ", categoryCode=" + categoryCode + "]";
	}
