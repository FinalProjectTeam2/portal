										...
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													...
													<span class="form-control" name="name" id="name" >
										...
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon">
													<i class="fa fa-user fa" aria-hidden="true"></i></span> 
													<span class="form-control" name="ssn" id="SSN">${vo.admissionfee} </span>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													...
													<span class="form-control" name="name" id="name">${vo.tuition }</span>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon">
													<i class="fa fa-user fa" aria-hidden="true"></i></span> 
													<span class="form-control" name="name" id="name">${vo.practicecost }</span>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													...
													<span class="form-control" name="name" id="name">${vo.studentfee } </span>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													...
													<span class="form-control" name="name" id="name">${vo.scholarship} </span>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon">
													<i class="fa fa-user fa" aria-hidden="true"></i></span> 
													<span class="form-control" name="name" id="name">${vo. reduction}</span>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon">
														<i class="fa fa-user fa" aria-hidden="true"></i></span> 
													<span class="form-control" name="name" id="name">${vo.depositState}</span>
												</div>
											</div>
										</div>
										<!--공통입력 항목 구분선  -->
