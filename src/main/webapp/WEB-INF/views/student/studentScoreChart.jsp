...
<script type="text/javascript">
	$(function() {
		...
		$("#btSearch").click(function() {
			$("form").attr("action","<c:url value='/student/studentScore'/>");
		});
			...
			<div class="divRight">
				<form name="frmList" method="post">
					<input type="hidden" value="${principal.name }" id="name"
						name="stuName"> <select name="semester" id="searchSelect">
									...
									<c:forEach var="list" items="${tlist}">
										...
										<tr>
											<td colspan="7" class="colLeft"><span><fmt:formatDate
														...
														value="${list[0]['OPEN_DATE']}" var="semester"
														pattern="MM" /> <c:if test="${semester==2 }">
									1학기
