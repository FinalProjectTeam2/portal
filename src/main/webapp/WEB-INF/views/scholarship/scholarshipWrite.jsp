						...
						<div class="container">
							...
							<div class="col">
								<form class="form-horizontal" method="post" id="form">
										...
										<div class="form-group">
											<label for="ssn" class="cols-sm-2 control-label">장학금분류</label>
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon"><i
														class="fa fa-user fa" aria-hidden="true"></i></span> 
														<input type="text" class="form-control" name="ssn" id="SSN" 
														placeholder="교내장학금/ 교외장학금" />
												</div>
											</div>
										</div>
										<div class="form-group">
											<label for="name" class="cols-sm-2 control-label">장학금명</label>
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon">
													<i class="fa fa-user fa" aria-hidden="true"></i>
													</span> 
														<input type="text" class="form-control" name="name" id="name" placeholder="장학금명을 입력하세요" />
												</div>
											</div>
										</div>
										<div class="form-group">
											<label for="name" class="cols-sm-2 control-label">장학금액</label>
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon">
										...
										<div class="form-group">
											<label for="name" class="cols-sm-2 control-label">승인여부</label>
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon"><i
														class="fa fa-user fa" aria-hidden="true"></i></span> 
														<input type="text" class="form-control" name="name" id="name"
														placeholder="승인대기/ 승인완료" />
												</div>
											</div>
										</div>
										<div class="form-group">
											<label for="name" class="cols-sm-2 control-label">승인날짜</label>
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon"><i
														class="fa fa-user fa" aria-hidden="true"></i></span> 
										...
										<div class="form-group">
											<label for="name" class="cols-sm-2 control-label">지급여부</label>
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon"><i
														class="fa fa-user fa" aria-hidden="true"></i></span> 
										...
										<div class="form-group">
											<label for="name" class="cols-sm-2 control-label">수여일</label>
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon"><i
														class="fa fa-user fa" aria-hidden="true"></i></span> 
