	...
	$(function() {
		$("#boardFrm").submit(function() {
			if(check()){
				...
				$.ajax({
					url : "/portal/admin/faculty/adminEditFacultyNameAjax",
					data : formData,
					type : "get",
			...
			<div class="row1">
				<div class="col-75">
					<label for="faculty" class="formTitle" style="color: #01539d">
						${facultyVo.facultyName}</label><label class="formTitle">&nbsp; 학부 수정</label>
				</div>
			</div>
			<div class="row1">
				<div class="col-75">
			...
			<div class="row1">
				<div class="">
					<input type="text" id="facultyName" name="facultyName"
						value="${facultyVo.facultyName}">
					<input type="hidden" id="facultyNo" name="facultyNo"
					value="${facultyVo.facultyNo}">
				</div>
			</div>
			<div class="bts">
