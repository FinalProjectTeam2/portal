...
<div class="certificate">
	...
	<div class="table">
		...
		<div class="row">
			<div class="cell">졸 업 년 월 일</div>
			<div class="cell2"><fmt:formatDate value="${map['GRADUATION_DATE'] }" pattern="yyyy년 MM월 dd일"/></div>
		</div>
		
		<div class="row">
			<div class="cell">학 위 등 록 번 호</div>
			<div class="cell2">척척10-가-12345</div>
		</div>
	</div>	
